from kls_mcmarr.mcmarr.response.response import Response as _Response
...
class Response(_Response):
    ...
    def generate_response(self, movement_finished, analyzed_movement_errors, movement, next_movement):
        ...
        counts = {}
        for message, priority in analyzed_movement_errors:
        ...
        if num_severe > 0:
            ...
            text_to_deliver = _("severe-error") + ". " + error_text + ". " + _("repeat-movement") + "."
        ...
        return text_to_deliver, correct
